                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                            <div>
                                <input className='px-4 py-3 w-full border border-zinc-500
                                 rounded outline-none hover:border-2' type="text" placeholder='Enter name' />
                            </div>
                            <div>
                                 <input className='px-4 py-3 w-full border border-zinc-500
                                 rounded outline-none hover:border-2' type="email" placeholder='Enter email' />
                            </div>
                        </div>
                        <div>
                            <input className='px-4 py-3 w-full border border-zinc-500 
                            rounded outline-none hover:border-2' type="text" placeholder='Enter Subject'/>
                        </div>
                        <div>
